...
/**
 * Esta interfaz se tiene que utilizar para obtener un usuario autenticado en el servidor Sauron con su perfil
 * y sus roles, asi como la lista de todos los roles del Realm donde se encuentra el cliente securizado. 
